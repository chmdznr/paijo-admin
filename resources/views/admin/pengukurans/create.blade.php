    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pengukurans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('identitas') ? 'is-invalid' : '' }}" name="identitas_id" id="identitas_id" required>
                    @foreach($identitas as $id => $entry)
                        <option value="{{ $id }}" {{ old('identitas_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('berat_badan') ? 'is-invalid' : '' }}" type="number" name="berat_badan" id="berat_badan" value="{{ old('berat_badan', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tinggi_badan') ? 'is-invalid' : '' }}" type="number" name="tinggi_badan" id="tinggi_badan" value="{{ old('tinggi_badan', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imt') ? 'is-invalid' : '' }}" type="number" name="imt" id="imt" value="{{ old('imt', '') }}" step="0.01">
                @if($errors->has('imt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('imt') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lingkar_perut') ? 'is-invalid' : '' }}" type="number" name="lingkar_perut" id="lingkar_perut" value="{{ old('lingkar_perut', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tekanan_darah_diastole') ? 'is-invalid' : '' }}" type="number" name="tekanan_darah_diastole" id="tekanan_darah_diastole" value="{{ old('tekanan_darah_diastole', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tekanan_darah_sistole') ? 'is-invalid' : '' }}" type="number" name="tekanan_darah_sistole" id="tekanan_darah_sistole" value="{{ old('tekanan_darah_sistole', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('frekuensi_nafas') ? 'is-invalid' : '' }}" type="number" name="frekuensi_nafas" id="frekuensi_nafas" value="{{ old('frekuensi_nafas', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nadi') ? 'is-invalid' : '' }}" type="number" name="nadi" id="nadi" value="{{ old('nadi', '') }}" step="1">
                @if($errors->has('nadi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nadi') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kadar_gula_darah') ? 'is-invalid' : '' }}" type="number" name="kadar_gula_darah" id="kadar_gula_darah" value="{{ old('kadar_gula_darah', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('waktu_pengambilan_gula_darah') ? 'is-invalid' : '' }}" name="waktu_pengambilan_gula_darah" id="waktu_pengambilan_gula_darah">
                    ...
                    @foreach(App\Models\Pengukuran::WAKTU_PENGAMBILAN_GULA_DARAH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('waktu_pengambilan_gula_darah', 'puasa') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolesterol_total') ? 'is-invalid' : '' }}" type="number" name="kolesterol_total" id="kolesterol_total" value="{{ old('kolesterol_total', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolesterol_ldl') ? 'is-invalid' : '' }}" type="number" name="kolesterol_ldl" id="kolesterol_ldl" value="{{ old('kolesterol_ldl', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolesterol_hdl') ? 'is-invalid' : '' }}" type="number" name="kolesterol_hdl" id="kolesterol_hdl" value="{{ old('kolesterol_hdl', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trigliserida') ? 'is-invalid' : '' }}" type="number" name="trigliserida" id="trigliserida" value="{{ old('trigliserida', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kadar_hb') ? 'is-invalid' : '' }}" type="number" name="kadar_hb" id="kadar_hb" value="{{ old('kadar_hb', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kadar_asam_urat') ? 'is-invalid' : '' }}" type="number" name="kadar_asam_urat" id="kadar_asam_urat" value="{{ old('kadar_asam_urat', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('golongan_darah') ? 'is-invalid' : '' }}" name="golongan_darah" id="golongan_darah">
                    ...
                    @foreach(App\Models\Pengukuran::GOLONGAN_DARAH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('golongan_darah', 'O') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('keluhan_perasaan') ? 'is-invalid' : '' }}" name="keluhan_perasaan" id="keluhan_perasaan">{!! old('keluhan_perasaan') !!}</textarea>
